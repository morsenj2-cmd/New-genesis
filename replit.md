...
- **Multi-Stage Generation Pipeline**: prompt → context reasoning → layout DNA generation → structure entropy → uniqueness validation → structural layout → constraints → diversity guard → style generation
