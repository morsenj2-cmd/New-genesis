...
- **Multi-Stage Generation Pipeline**: prompt → semantic interpretation → context retrieval → internet enrichment → layout DNA generation → structure entropy → uniqueness validation → structural layout → constraints → style generation
